...
- (instancetype)init{
    ...
    self.modalBackgroundColor = [UIColor colorWithWhite:128 alpha:0.5];
...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated andTopY:(NSInteger)iTopY
{
    ...
    if(iTopY == 0)
        iTopY = round(CGRectGetMidY(self.window.bounds)-CGRectGetMidY(containerViewRect));
    containerViewRect.origin.y = iTopY;
    
    ///CGRect containerViewRect = CGRectMake(10, 40, 300, 400);
...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated {
    [self showWithContentView:contentView andAnimated:YES andTopY:0];
}
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    styleLayer.borderColor = COLOR_BTN_BORDER_1.CGColor;//[[UIColor whiteColor] CGColor];
