...
@synthesize delegate;
@synthesize roundedRect, closeButton, contentView, contentContainer;
...
- (UIButton*)closeButton {
	if (!closeButton) {
		...
		[self.closeButton setImage:[UIImage imageNamed:@"uamodalpanel_close.png"] forState:UIControlStateNormal];
