...
@interface SBPageFlowView : UIView<UIScrollViewDelegate>{
    ...
    id <SBPageFlowViewDataSource>   dataSource;
    id <SBPageFlowViewDelegate>     delegate;

}

@property (nonatomic, unsafe_unretained) id <SBPageFlowViewDataSource> dataSource ;
@property (nonatomic, unsafe_unretained) id <SBPageFlowViewDelegate>   delegate;
